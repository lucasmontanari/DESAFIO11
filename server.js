...
const args = yargs(process.argv.slice(2)).alias({ p: 'port', n: 'name' })
  .default({ port: 8080, name: 'Lucas' }).argv
...
const expressServer = app.listen(process.env.PORT || args.port, () => console.log(`Servidor escuchando puerto ${process.env.PORT || args.port}`))
